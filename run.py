...
def main(config):
    ...
    ckpt_callback = ModelCheckpoint(dirpath=exp_ckpt_dir,
                                    filename='{epoch}',
                                    save_last=True
                                    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', '-c',
                        ...
                        default='configs/train/semantic3d_self_ft.yaml')
